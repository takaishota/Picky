...
function wpma_file_get_html() {
    $dom = new wpma_simple_html_dom;
    $args = func_get_args();
...
function wpma_str_get_html($str, $lowercase=true) {
    $dom = new wpma_simple_html_dom;
...
function wpma_str_get_dom($str, $lowercase=true) {
    $dom = new wpma_simple_html_dom;
    $dom->load($str, $lowercase);
    return $dom;
}
...
// -----------------------------------------------------------------------------
class wpma_simple_html_dom_node {
    ...
    function wpma_simple_html_dom_node($dom)
    {
        ...
        for ($c=0; $c<$count; ++$c) {
            ...
            for ($l=0; $l<$levle; ++$l) {
                ...
                foreach($head as $k=>$v) {
                    ...
                    if(isset($n))$n->seek($selectors[$c][$l], $ret);
                }
                $head = $ret;
            }
...
class wpma_simple_html_dom {
    ...
    function wpma_simple_html_dom($str = null)
    {
    ...
    function prepare($str, $lowercase=true) {
        ...
        $this->root = new wpma_simple_html_dom_node($this);
        $this->root->tag = 'root';
    ...
    function parse() {
        ...
        // text
        $node = new wpma_simple_html_dom_node($this);
        ++$this->cursor;
